...
#usuallly need at least one argument
log(10)
#nested from inside out
log(exp(1))
...
# name have to start with letter no space 
...
a <- c("Massachusetts") %in% murders$state
a
...
data(olive)
head(olive)
plot(olive$palmitic, olive$palmitoleic) #There is a positive linear relationship between palmitic and palmitoleic
#9
