---
title: "Productivity Tools: Section 1"
author: "Gustavo Roa"
date: "2023-10-03"
format: html
editor: source
...
```{r}
#Code
#("dslabs")  # to install a single package
...
Download Git bash from <https://git-scm.com/> When asked to choose the default editor for Git, we recommend choosing nano if you do not already know VIM.

The "git and optional Unix tools from Windows" option will allow you to learn Unix from Rstudio, however, it might interfere with the Windows command line. Finally, change the Rstudio preference so that you are using Git bash as the terminal (only for Windows user).
